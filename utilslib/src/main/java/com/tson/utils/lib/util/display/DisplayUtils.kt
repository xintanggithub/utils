package com.tson.utils.lib.util.display
...
class DisplayUtils {
    companion object {
        ...
        fun px2dp(pxValue: Float): Int {
            val scale = UtilsConfig.sContext.getResources().getDisplayMetrics().density
        ...
        fun px2sp(pxValue: Float): Int {
            val scale = UtilsConfig.sContext.getResources().getDisplayMetrics().scaledDensity
            return (pxValue / scale + 0.5f).toInt()
        }
